...
$log_message = "[$timestamp] Pending callback: payment_id=$payment_id, external_reference=$external_reference, status=$status\n";
file_put_contents($logFile, $log_message, FILE_APPEND);

// Redirecionar para a página principal com parâmetros de pendente
